...
export interface StorageDriver {
  ...
  createMergeAdviceRun(run: import("@invest/domain").MergeAdviceRun): Promise<boolean>;
  finishMergeAdviceRun(run: import("@invest/domain").MergeAdviceRun): Promise<void>;
  getMergeAdviceRun(id: string): Promise<import("@invest/domain").MergeAdviceRun | null>;
  getMergeAdviceRuns(limit: number): Promise<import("@invest/domain").MergeAdviceRunSummary[]>;
  recoverMergeAdviceRuns(): Promise<void>;
  ...
  getTradingLessons(): Promise<import("@invest/domain").TradingLesson[]>;
  createTradingLesson(lesson: import("@invest/domain").TradingLesson): Promise<void>;
  updateTradingLesson(id: string, update: (lesson: import("@invest/domain").TradingLesson) => import("@invest/domain").TradingLesson): Promise<import("@invest/domain").TradingLesson | null>;
